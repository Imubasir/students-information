...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '28' ";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <li class="nav-item dropdown active keep-open">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="users_tab" class="dropdown-item active" href="../1242"><i class="fas fa-user-plus"></i> Users</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <span style="float:right;"><button onclick="addUser()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add User</button></span>Users
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped" id="userTable">
                                ...
                                <tbody id="userBody" style="text-transform: uppercase;">
                        ...
                        <form id="userForm">
                            <div class="row">
                                <div class="form-group">
                                    <img src="../images/avatar.png" id="output" class=" align-self-center rounded-circle" width="100px" height="100px" style="border:1px dotted #f1f1f1;margin-left: 25%" /><br><br>
                                    <input id="prof_pic" type="file" name="image" accept="image/*" class="form-control" onchange="loadFile(event)">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <select name="status" class="form-control">
                                            <option selected disabled>Transcript Isssue</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            <div class="row">
                                <div class="form-group">
                                    <img src="../images/avatar.png" onerror="if(this.src != '../images/avatar.png') {this.src = '../images/avatar.png'}" id="e_output" class=" align-self-center rounded-circle" width="100px" height="100px" style="border:1px dotted #f1f1f1;margin-left: 25%" /><br><br>
                                    <input id="prof_pic" type="file" name="e_image" accept="image/*" class="form-control" onchange="loadFile(event)">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="text" id="e_f_name" name="e_f_name" class="form-control">
                                            <label>First Name</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="text" id="e_m_name" name="e_m_name" class="form-control">
                                            <label>Middle Name</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="text" id="e_l_name" name="e_l_name" class="form-control">
                                            <label>Last Name</label>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <select id="e_gender" name="e_gender" class="form-control">
                                            <option selected disabled>Select Gender</option>
                                            <option>Male</option>
                                            <option>Female</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <select id="e_title" name="e_title" class="form-control">
                                            <option selected disabled>Select Title</option>
                                            <option>Dr</option>
                                            <option>Mr</option>
                                            <option>Miss</option>
                                    ...
                                    <div class="form-group">
                                        <select id="e_status" name="e_status" class="form-control">
                                            <option selected disabled>Transcript Issue</option>
                                            <option value='1'>Yes</option>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="text" id="e_s_id" name="e_s_id" class="form-control">
                                            <label>Staff ID</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="date" id="e_dob" name="e_dob" class="form-control">
                                            <label>DOB</label>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="access" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <img src="../images/lock.ico" width="50px" height="50px">&nbsp;&nbsp;<h4 class="modal-title" id="exampleModalLabel">Access Level</h4>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body" style="text-transform: uppercase;">
                    <div class="table-responsive">
                        <table class=" table-hover table-striped" id="dataTable_2" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th class="check-mail" style="width: 40%"><input type="checkbox" class="" id="checkAll" />&nbsp;&nbsp;Check All</th>
                                    <th>Page</th>
                                </tr>
                            </thead>
                            <tbody id="accessbody">
                ...
                <div class="modal-footer">
                    <button id="add_access" class="btn btn-success btn-sm">Update</button>
