                            ...
                            <tr style="line-height: initial;border-bottom: 2px solid black;">
                                ...
                                <td colspan="4" class="style1"><div style="text-align:center;margin-left: -100px"><span class="style53">UNIVERSITY FOR DEVELOPMENT STUDIES</span><br>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%;" rowspan="3"><img id="profile_pic" src="../images/avatar.png" width="100px" height="100px"></td>
                                    </tr>
                                    <tr>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += "<tr><td>" + uin + "</td><td>" + id + "</td><td>" + name + "</td><td>" + prog + "</td><td><button class='btn btn-sm btn-info' onclick ='refresh_results(\"" + id + "\")'>Refresh Results</button></td><td><button class='btn btn-sm btn-success' onclick ='viewResults(\"" + id + "\")'>View Results</button></td></tr>";
                            }
        ...
        css: ["../vendor/datatables/dataTables.bootstrap4.css", "../vendor/fontawesome-free/css/all.min.css", "../vendor/bootstrap/css/bootstrap.min.css", "style.css"]
            ...
            function refresh_results (id) {
                $.ajax({
                    ...
                    // data: 'Faculty='+id+'&UserID=ICTD&UserPassword=bash@5910',
