...
if($sid != '' && $prog != '' &&  $entryyear != '') {
    ...
    $query .= "SELECT * FROM studentbiodata
        LEFT JOIN programme ON sprogid = progid LEFT JOIN faculty ON facid = faculty.facultyid LEFT JOIN tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid' and sprogid = '$prog' and entryyear = '$entryyear'";
} 
    ...
    $query .= "SELECT * FROM studentbiodata
        LEFT JOIN programme ON sprogid = progid LEFT JOIN faculty ON facid = faculty.facultyid LEFT JOIN tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid' and entryyear = '$entryyear' ";
} 
else if ($sid != '' && $prog != '') {
    $query .= "SELECT * FROM studentbiodata
        LEFT JOIN programme ON sprogid = progid LEFT JOIN faculty ON facid = faculty.facultyid LEFT JOIN tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid' and sprogid = '$prog'";
} 
else if ( $entryyear != '') {
    $query .= "SELECT * FROM studentbiodata
    ...
    $query .= "SELECT * FROM studentbiodata
        LEFT JOIN programme ON sprogid = progid LEFT JOIN faculty ON facid = faculty.facultyid LEFT JOIN tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid'";
} 
else if ($name != '') {
    $query .= "SELECT * FROM studentbiodata
