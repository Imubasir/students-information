...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '6' ";
...
<head>
    ...
    <title><?php echo $title."Postgraduate Courses" ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            ...
            <div class="card-header user-header alt bg-dark">
                <div class="media">
                    ...
                    <div class="media-body">
                        <img class="align-self-center rounded-circle mr-3" src="../uploads/IMG-20180507-WA0010.jpg" onerror='if(this.src != "../images/avatar.png") this.src = "../images/avatar.png" ' width="70px" height="70px">
                        <h4 class="text-light display-6">Issah Mubasir</h4>
                        <p>Directorate of ICT</p>
                    </div>
                </div>
            </div>
            <br />
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="pg_course_tab" class="dropdown-item active" href="../3394"> Courses</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <i class=""></i>Postgraduate Courses
                    </div>

                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="courseTable">
                                <thead>
                                    <tr>
                                        <th>SN</th>
                                        <th>Code</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="conUpdate" class="btn btn-primary btn-sm">Update</button>
        ...
        <div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                        <button id="conDelete" class="btn btn-primary btn-sm">Delete</button>
