        ...
        <div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                        ...
                        <form id="reqForm">
                            ...
                            <div class="form-group" id="cf_q" style="display: none;">
                                <div class="form-label-group">
                                    ...
                                    <label>Confirmatory Quantity</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="ep_q" style="display: none;">
                                <div class="form-label-group">
                                    ...
                                    <label>English Proficiency Quantity</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="il_q" style="display: none;">
                                <div class="form-label-group">
                                    ...
                                    <label>Introductory Letter Quantity</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="trans_q" style="display: none;">
                                <div class="form-label-group">
                                    ...
                                    <label>Transcript Quantity</label>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                <select class="form-control" name="req_del">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                        <button id="req_send_btn" class="btn btn-primary btn-sm">Add</button>
