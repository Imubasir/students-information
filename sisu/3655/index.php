                            ...
                            <table class="table table-hover table-striped table-bordered" id="enrollTable">
                                ...
                                <tbody style="text-transform: uppercase;" id="enrollBody">
                                    ...
                                    <tr>
                                        ...
                                        <td onclick="view_details('<?php echo $row['uin'] ?>')" class="detail_row" data-toggle='tooltip' title='Click to View More'><?php echo $row['surname'].' '.$row['middlename'].' '.$row['firstname'] ?></td>
