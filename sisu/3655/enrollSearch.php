...
if($sid != '' && $prog != '' &&  $entryyear != '') {
    ...
    $query .= "SELECT * FROM arms_pg.studentbiodata
        LEFT JOIN arms_pg.programme ON sprogid = progid LEFT JOIN arms.faculty ON facid = faculty.facultyid LEFT JOIN arms.tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid' and sprogid = '$prog' and entryyear = '$entryyear'";
} 
    ...
    $query .= "SELECT * FROM arms_pg.studentbiodata
        LEFT JOIN arms_pg.programme ON sprogid = progid LEFT JOIN arms.faculty ON facid = faculty.facultyid LEFT JOIN arms.tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid' and entryyear = '$entryyear' ";
} 
else if ($sid != '' && $prog != '') {
    $query .= "SELECT * FROM arms_pg.studentbiodata
    ...
    $query .= "SELECT * FROM arms_pg.studentbiodata
        LEFT JOIN arms_pg.programme ON sprogid = progid LEFT JOIN arms.faculty ON facid = faculty.facultyid LEFT JOIN arms.tbl_campus ON tbl_campus.campus_id = fcampus_id WHERE indexno = '$sid'";
} 
else if ($name != '') {
    $query .= "SELECT * FROM arms_pg.studentbiodata
