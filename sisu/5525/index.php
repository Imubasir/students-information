                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="gradTable">
                                ...
                                <tbody id="gradTableBody" style="text-transform: uppercase;">
									...
									$sql = "SELECT * FROM tbl_graduate INNER JOIN studentbiodata on studentbiodata.indexno = tbl_graduate.indexno LEFT JOIN programme on studentbiodata.sprogid = programme.progid where graddate ='$dat'";
