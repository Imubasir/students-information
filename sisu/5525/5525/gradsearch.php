...
if($sid != '' && $name != '' && $prog != '' && $graddate != '') {
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and studentbiodata.sprogid = '$prog' and graddate = '$graddate' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where studentbiodata.sprogid = '$prog' and graddate = '$graddate' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', surname, middlename, firstname) LIKE '%{$name}%' and graddate = '$graddate' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', surname, middlename, firstname) LIKE '%{$name}%' and studentbiodata.sprogid = '$prog' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and graddate = '$graddate' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and studentbiodata.sprogid = '$prog' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and concat_ws(' ', surname, middlename, firstname) LIKE '%{$name}%' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where graddate = '$graddate'";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where studentbiodata.sprogid = '$prog' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', surname, middlename, firstname) LIKE '%{$name}%' and studentbiodata.qualification_status != 'Fake' ";
    ...
    //$query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.Sindexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and studentbiodata.qualification_status != 'Fake' ";
