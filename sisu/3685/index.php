              ...
              <table class="table table-hover table-striped" id="sigTable">
                <thead>
                  ...
                  <tbody id="sigBody" style="text-transform: uppercase;">
                    ...
                    // $sql = "SELECT * FROM tbl_sign order by ID ASC";
                    ...
                    //         <td><?php/// echo date('d-M-Y', strtotime($row['last_active'])) ?></td>
                    //         <td><?php// if($row['status'] == "Active"){echo "<button onclick='activate(".$row['ID'].")' class='btn btn-sm btn-danger'>Activated</button>";} else {echo "<button onclick='activate(".$row['ID'].")' class='btn btn-sm btn-success'>Deactivated</button>";} ?></td>
                    //       </tr> -->
                         <?php
                    //   }
                    // }
