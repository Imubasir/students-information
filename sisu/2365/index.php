...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '4' ";
...
<head>
    ...
    <title><?php echo $title."Notifications" ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="notification_tab" class="dropdown-item active" href="../2365"><i class="far fa-bell"></i> Notification</a>                                   
          </div>
        </li>           
           <!--End of Dashboard-->
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    ...
                    <div class="card-body">
                        <div class="x_content">
                            <ul class="list-unstyled timeline" id="timeline">
