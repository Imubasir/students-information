            ...
            foreach ($Reader as $Row){
                ...
                if($indexno == '') {
                    ...
                    if ($rs_check->num_rows < 1) {
                        ...
                        $sql_insert = "UPDATE conass SET coursecode1 = '$coursecode', trimester = '$trimester', credits = '$credits', mark = '$mark', grade= '$grade', w = '$w', gp = '$gp', course_title = '$title', added_by = '$user' WHERE indexno = '$indexno' and levelid = '$levelid' and trimester = '$trimester' and session = '$session' ";
