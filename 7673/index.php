...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '22' ";
...
<head>
    ...
    <title><?php echo $title."Campus Settings" ?></title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <li class="nav-item dropdown active keep-open">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            <a id="campus_tab" class="dropdown-item active" href="../7673"><i class="far fa-building"></i> Campus</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <span style="float:right;"><button onclick="addCampus()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Campus</button></span>Campus Settings
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody id="campusBody" style="text-transform: uppercase;">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label class="label">Campus Name</label>
                                <input type="text" id="campus_name" class="form-control">
                            </div>
                            
                            <div class="form-group">
                                <label class="label">Region</label>
                                <select id="region" class="form-control">
                                    <option selected disabled value="">Select Region of Campus</option>
                                    <?php
                                        // require_once('../Db/connection.php');
                                        $sql = "SELECT * FROM region where regionname != '' order by regionname ASC";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label class="label">Campus Name</label>
                                <input type="text" id="addCampus_name" class="form-control">
                            </div>
