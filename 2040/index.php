...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '19' ";
...
<head>
    ...
    <title><?php echo $title."Requests" ?></title>
    ...
    <div id="wrapper">
        ...
        <li class="nav-item dropdown">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="request_tab" class="dropdown-item active" href="../2040">Request</a>                                   
          </div>
        </li>
        <!--End of Transcript-->
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Requests</li>
                </ol>
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <b>Requests List</b>
                        <span style="float: right"><button class="btn btn-sm btn-success" onclick="addRequest()">Add Request</button></span>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped" id = 'request_tbl'>
                                ...
                                <tbody id="req_table" style="text-transform: uppercase;">
                                 <tr>
        ...
        <div class="modal fade" id="dispatch_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Dispatch Address</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body" id="dispatch_body">
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                        <button onclick="" class="btn btn-primary btn-sm">Dispatched</button>
        ...
        <div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><img src="../images/add_4.png" height="30px"> Add Request</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="reqForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="stud_id" name="stud_id" class="form-control">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                <input type="text" id="prog" name="prog" class="form-control" readonly="">
                                    <label>Programme</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <select class="form-control" id="req_" name="req_" multiple="">
                                    <option disabled="" selected="" value="">Select Request(s)</option>
                                    <option value="cf">Confirmatory Letter</option>
                                    <option value="ep">English Proficiency Letter</option>
                                    <option value="il">Introductory Letter</option>
                                    <option value="visa">Introductory Letter (Visa)</option>
                                    <option value="trans">Transcript</option>
                                </select>
                            </div>

                            <div class="form-group" id="cf_q" style="display: none;">
                                <div class="form-label-group">
                                    <input type="number" name="cf_q" class="form-control">
                                    <label>Confirmatory Copies</label>
                                </div>
                            </div>

                            <div class="form-group" id="ep_q" style="display: none;">
                                <div class="form-label-group">
                                    <input type="number" name="ep_q" class="form-control">
                                    <label>English Proficiency Copies</label>
                                </div>
                            </div>

                            <div class="form-group" id="il_q" style="display: none;">
                                <div class="form-label-group">
                                    <input type="number" name="il_q" class="form-control">
                                    <label>Introductory Letter Copies</label>
                                </div>
                            </div>

                            <div class="form-group" id="trans_q" style="display: none;">
                                <div class="form-label-group">
                                    <input type="number" name="trans_q" class="form-control">
                                    <label>Transcript Copies</label>
                                </div>
                            </div>

                            <div class="form-group" id="visa_q" style="display: none;">
                                <div class="form-label-group">
                                    <input type="number" name="visa_q" class="form-control">
                                    <label>Visa Copies</label>
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                <select class="form-control" id="" name="req_del">
                                    <option disabled="" selected="" value="">Delivery Type</option>
                                    <option>DHL</option>
                            ...
                            <div class="form-group" style="display: none">
                                <textarea class="form-control" name="req_del_addrs" style="height: 100px" placeholder="Enter Address to Send Requested Documents"></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                        <button id="req_send_btn" class="btn btn-primary btn-sm">Add Request</button>
        ...
        <!-- Read API Requests -->
        <div class="modal fade" id="apirequestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel"><img src="../images/ghapes.png" height="30px"> Ghapes Requests</h4>
         ...
         <!-- No API Requests -->
        <div class="modal fade" id="norequestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel"><img src="../images/ghapes.png" height="30px"> Ghapes Requests</h4>
                    ...
                    <div class="modal-body">
                        <div style="text-align: center;color: #db2323;font-family: monospace;">
        ...
        <div class="modal fade" id="requestDetailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel"><img src="../images/ghapes.png" height="30px"> Ghapes Requests Details</h4>
                    </div>
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <tbody>
                                    <tr>
                                        <th>Invoice #</th>
                                        <td id="ghapes_inv_id"></td>
                                    </tr>

                                    <tr>
                                        <th>Service</th>
                                        <td id="ghapes_requests"></td>
                                    </tr>

                                    <tr>
                                        <th>Name</th>
                                        <td id="ghapes_name"></td>
                                    </tr>

                                    <tr>
                                        <th>Email</th>
                                        <td id="ghapes_email"></td>
                                    </tr>

                                    <tr>
                                        <th>Contact</th>
                                        <td id="ghapes_contact"></td>
                                    </tr>

                                    <tr>
                                        <th>Postal Service</th>
                                        <td id="ghapes_service"></td>
                                    </tr>

                                    <tr>
                                        <th>Postal Address</th>
                                        <td id="ghapes_address"></td>
                                    </tr>
                                </tbody>
                            </table>
