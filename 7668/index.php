...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '24' ";
...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $title."Department Settings" ?></title>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown active keep-open">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="department_tab" class="dropdown-item active" href="../7668"><i class="fas fa-city"></i> Departments</a>
        ...
        <!-- /.container-fluid -->
            <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <span style="float:right;"><button onclick="addDepartment()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Department</button></span>Departments
                    </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="deptTable">
                            ...
                            <tbody id="deptBody" style="text-transform: uppercase;">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form id="editForm">
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="e_deptname" name="e_deptname" class="form-control">
                          <label>Department Name</label>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="e_hod" name="e_hod" class="form-control">
                          <label>Head of Department</label>
                      </div>
                  </div>
                  
                  <div class="form-group">
                     <select class="form-control" id="e_faculty" name="e_faculty">
                         <option value="" selected disabled>Select Faculty</option>
                         <?php
                            // require_once('../Db/connection.php');
                            $sql = "SELECT * FROM faculty order by facultyname ASC";
                  ...
                  <div class="form-group">
                     <select class="form-control" id="e_campus" name="e_campus">
                         <option value="" selected disabled>Select Campus</option>
                         <?php
                            // require_once('../Db/connection.php');
                            $sql = "SELECT * FROM tbl_campus order by campus_descr ASC";
