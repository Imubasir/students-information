...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $title."Undergraduate Programmes" ?></title>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="ug_programme_tab" class="dropdown-item active" href="../9734"> Programmes</a>
        ...
        <!-- /.container-fluid -->
            <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <i class=""></i>Undergraduate Programmes
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="progTable">
                                ...
                                <tbody style="text-transform: uppercase;">
                                    ...
                                    $sql = "SELECT * FROM programme LEFT JOIN faculty ON facid = faculty.facultyid LEFT JOIN department ON programme.dept_id = department.deptid LEFT JOIN tbl_campus ON fcampus_id = tbl_campus.campus_id ORDER BY progname ASC";
