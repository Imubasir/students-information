...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '30' ";
    ...
    <div id="wrapper">
      ...
      <!-- Sidebar -->
        <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            <a id="pg_certification_tab" class="dropdown-item active" href="../1326"> Certification</a>
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3 animated fadeInRight">
                  ...
                  $dat='JULY 31, '.date('Y');
                  $sql = "SELECT * FROM tbl_graduate LEFT JOIN studentbiodata on studentbiodata.indexno = tbl_graduate.indexno LEFT JOIN programme on studentbiodata.sprogid = programme.progid where graddate ='$dat'";
