...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '20' ";
...
<head>
    ...
    <title><?php echo $title."General Analytics" ?></title>
    ...
    <link href="../css/custom_report.css" rel="stylesheet" />
    <!-- FullCalendar -->
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown active keep-open">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <a id="general_tab" class="dropdown-item active" href="../8324">General</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <span style="float: right;"><button class="btn btn-sm btn-success" onclick="customReport()">Custom Report</button></span>
                        General Report
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Population Growth <small>Yearly</small></h2>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="" class="btn btn-primary btn-sm">Generate</button>
