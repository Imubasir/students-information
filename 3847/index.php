...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '25' ";
...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $title."Programme Settings" ?></title>
  ...
  <body id="page-top">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown active keep-open">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="programme_tab" class="dropdown-item active" href="../3847"><i class="fas fa-book-open"></i> Programmes</a>
            ...
            <div class="card mb-3 animated fadeInRight">
              <div class="_card-header">
                    ...
                    <div class="card-header">
                        <span id="sub_title">Programmes</span>
                    </div>
                <div class="card-body" id="ucardBody">
                  <span style="float:right;"><button onclick="addProgramme()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Programme</button></span><br><br>
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="progTable">
                            <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>Programme</th>
                            ...
                            <tbody id="progBody" style="text-transform: uppercase;">
                ...
                <div class="card-body" id="ucardBody2">
                  <span style="float:right;"><button onclick="PG_addProgramme()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Programme</button></span><br><br>
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="pg_progTable">
                            <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>Programme</th>
                            ...
                            <tbody id="PG_progBody" style="text-transform: uppercase;">
    ...
    <!-- Delete Modal-->
        <div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Delete Programme?</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
    ...
    <!--PG Delete Modal-->
        <div class="modal fade" id="pgdelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Delete Programme?</h5>
                    ...
                    <div class="modal-body" id="pgdelBody">
                        
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
                        <button id="pgdelBtn" class="btn btn-primary btn-sm">Delete</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form id="progForm">
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" name="progfullname" class="form-control">
                          <label>Programme Full Name</label>
                      </div>
                  </div>
                                    
                  <div class="form-group">
                     <select class="form-control" name="dept" style="text-transform: uppercase;">
                  ...
                  <div class="form-group">
                    <select class="form-control" id="prg_status" name="prg_status">
    ...
    <div class="modal fade" id="pg_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Post Programme</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
              <form id="pg_progForm">
                  ...
                  <div class="form-group">
                    <select class="form-control" id="pg_prg_status" name="pg_prg_status">
                      <option value="">SELECT PROGRAMME STATUS</option>
                      <option value="ACTIVE">ACTIVE</option>
                      <option value="INACTIVE">INACTIVE</option>
                    </select>
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Dismiss</button>
            <button id="pg_addBtn" class="btn btn-primary btn-sm">Add</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form id="editForm">
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="e_progname" name="e_progname" class="form-control">
                          <label>Programme Name</label>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="e_progfullname" name="e_progfullname" class="form-control">
                          <label>Programme Full Name</label>
                      </div>
                  </div>
                                    
                  <div class="form-group">
                     <select class="form-control" id="e_dept" name="e_dept" style="text-transform: uppercase;">
                         <option value="" selected disabled>Select Department</option>
                         <?php
                            // require_once('../Db/connection.php');
                            $sql = "SELECT * FROM department order by deptname ASC";
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="number" id="e_duration" name="e_duration" class="form-control">
                          <label>Programme Duration</label>
                      </div>
                  </div>

                  <div class="form-group">
                    <select class="form-control" id="e_prg_status" name="e_prg_status">
                      <option value="">SELECT PROGRAMME STATUS</option>
                      <option value="ACTIVE">ACTIVE</option>
                      <option value="INACTIVE">INACTIVE</option>
                    </select>
    ...
    <!-- PG Edit Modal-->
    <div class="modal fade" id="pg_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Programme</h5>
          ...
          <div class="modal-body">
              <form id="pg_editForm">
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="pg_e_progname" name="pg_e_progname" class="form-control">
                          <label>Programme Name</label>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="text" id="pg_e_progfullname" name="pg_e_progfullname" class="form-control">
                          <label>Programme Full Name</label>
                      </div>
                  </div>
                                    
                  <div class="form-group">
                     <select class="form-control" id="pg_e_dept" name="pg_e_dept" style="text-transform: uppercase;">
                         <option value="" selected disabled>Select Department</option>
                         <?php
                            // require_once('../Db/connection.php');
                            $sql = "SELECT * FROM department order by deptname ASC";
                  ...
                  <div class="form-group">
                      <div class="form-label-group">
                          <input type="number" id="pg_e_duration" name="pg_e_duration" class="form-control">
                          <label>Programme Duration</label>
                      </div>
                  </div>

                  <div class="form-group">
                    <select class="form-control" id="pg_e_prg_status" name="pg_e_prg_status">
                      <option value="">SELECT PROGRAMME STATUS</option>
                      <option value="ACTIVE">ACTIVE</option>
                      <option value="INACTIVE">INACTIVE</option>
                    </select>
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Dismiss</button>
            <button id="pg_editBtn" class="btn btn-primary btn-sm">Update</button>
    ...
    <script type="text/javascript">
      ...
      $("#sub_title").html("Undergraduate Programmes");
                ...
                $("#PgradList").click(function() {
                    ...
                    $("#sub_title").html("Postgraduate Programmes");
                })
    </script>
