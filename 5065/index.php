...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <span id="enroll_search" style="float:right;"><button class="btn btn-sm btn-success" onclick="enrolSearch()">Custom Search</button></span>
                        <span style="display: none" id="enroll_title"><i class=""></i>Undergraduate Enrollment</span>

                        <!-- <span style="float: right;margin-right: 10px;"><button class="btn btn-sm btn-info" data-toggle="modal" data-target="#updateucm">Update UCM</button></span> -->
                        
                        <span id="loan_search" style="float:right;display: none"><button class="btn btn-sm btn-success" onclick="enrolSearch()">Custom Search</button></span>
                        
                        <span style="display: none" id="loan_title"><i class=""></i>Student Loan Data</span>
                    </div>

                    <ul class="head_nav">
                        <a href="#"onclick="enroll_switch();"><li class="head_li active">Enrollment</li></a>
                        <a href="#"onclick="loan_switch();"><li class="head_li">Student Loan</li></a>
                    </ul>
                    ...
                    <div class="card-body">
                        ...
                        <div id="loanSearchContainer" style="width: 50%; margin-left: 25%;">
                        <form id="loanForm">
                            <div class="form-group">
                                <div class="form-label-group" style="text-transform: uppercase;">
                                    <input type="text" class="form-control" name="loan_sid">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    <select name="loan_programme" class="form-control" style="text-transform: uppercase;">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    <select name="loan_acadYr" class="form-control" style="text-transform: uppercase;">
                        ...
                        <button onclick="load_loan()" class="btn btn-md btn-success">Load Data</button>
                    </div>
                        <div id="loan_table" style="display: none;">
                            <span style="float: right;"><button onclick="goback();" class="btn btn-sm btn-danger">Go Back</button></span><br><br>
                            <table class="table table-hover" id="loan_tbl">
                                <thead>
                                    <th>#</th>
                                ...
                                <tbody id="loan_body">
                                    <tr>
                                        <td style="text-align: center;" colspan="10"><img src="../images/gear.gif"></td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="printable">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <img id="profile_pic" src="../images/avatar.png" onerror='if(this.src != "../images/avatar.png") this.src = "../images/avatar.png"' width="150px" height="150px">
                            </div>
                            ...
                            <div class="col-12">
                                <table class="table_profile">
                                    ...
                                    <tr>
                                        ...
                                        <td><span id="fee_cat" style="text-transform: uppercase;"></span></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                </table>
        ...
        <!-- Update UCM Modal-->
        <div class="modal fade" id="updateucm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-redo"></i> Update UCM</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="updateucm_form">
                            <div class="form-group">
                                <label>Update Type</label>
                                <select name="up_type" id="up_type" class="form-control" style="text-transform: uppercase;">
                                    <option>Biodata</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label>Update Group (Programme) <br>(For all Programmes, leave this field empty)</label>
                                <select name="up_programme" id="up_programme" class="form-control" style="text-transform: uppercase;">
                                        <option value=""></option>
                                        <?php
                                                // require_once('../Db/connection.php');
                                                $sql = "SELECT * FROM programme order by progname";
                            ...
                            <div class="form-group">
                                <label>Update Level <br>(For all levels, leave this field empty)</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="update_ucm()" class="btn btn-success btn-sm">Initiate Update</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <!-- Waiting Modal-->
        <div class="modal fade" id="waiting_notice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body" style="text-align: center;">
                        <button class="close" type="button" title="Close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                        <span><img src="../images/Ball-1s-204px.gif" width="100px"></span>
                        <div>
                            <h5>Update Type: <span id="upd_type"></h5><br>
                            <h5>Update Group: <span id="upd_group"></h5><br>
                            <h5>Update Level: <span id="upd_level"></h5><br>
                            <h4>Update Initiated...please wait</h4>
                        </div>
                    </div>
                </div>
            </div>
