...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '12' ";
...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $title."Postgraduate Programmes" ?></title>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="pg_programme_tab" class="dropdown-item active" href="../7738"> Programmes</a>
        ...
        <!-- /.container-fluid -->
            <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <i class=""></i>Postgraduate Programmes
                    </div>

                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="progTable">
                                <thead>
                                    <tr>
                                        <th>SN</th>
                                        <th>Title</th>
                                ...
                                <tbody style="text-transform: uppercase;">
                                    ...
                                    $sql = "SELECT * FROM arms_pg.programme 
                                            LEFT JOIN arms.department ON arms.department.deptid=arms_pg.programme.dept_id 
                                            LEFT JOIN arms.faculty ON arms.faculty.facultyid=facid
                                            LEFT JOIN arms.tbl_campus ON arms_pg.programme.campus_id = arms.tbl_campus.campus_id order by progname ASC";
