...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '5' ";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            <a id="certification_tab" class="dropdown-item active" href="../5525"> Certification</a>
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="_card-header">
                        ...
                        <ul id="ol">
                            ...
                            <li id="otherveri"><i class="fas fa-clipboard-check"></i> Other Verification</li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="gradTable">
                                ...
                                <tbody id="gradTableBody" style="text-transform: uppercase;">
									...
									$sql = "SELECT * FROM tbl_graduate INNER JOIN studentbiodata on studentbiodata.indexno = tbl_graduate.indexno LEFT JOIN programme on studentbiodata.sprogid = programme.progid LEFT JOIN tbl_option ON tbl_option.optionid = studentbiodata.option_id LEFT JOIN tbl_balance ON studentbiodata.uin = tbl_balance.uin where graddate ='$dat'";
                    ...
                    <div class="card-body" id="veriBody" style="display:none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="veriTable">
                                ...
                                <tbody id="veriTableBody" style="text-transform: uppercase;">
                    ...
                    <!-- Other Verification List-->
                    <div class="card-body" id="otherveriBody" style="display:none;">
                        <span style="float:right;display: block;"><button class="btn btn-sm btn-danger" data-target="#edit" data-toggle="modal"><i class="fas fa-search"></i> Edit</button></span><br><br>
                        <div style="background-color: #f1f1f1;width: 50%;margin-left: 25%;padding: 20px">

                           <!--  <div style="display: none;">
                                
                            </div> -->
                        <form id="otherveriForm">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="month" name="examDate" id="examDate" class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <div>
                                    <label for="certName">Institution Attended:</label>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="certName">Name on Certificate:</label>
                                    <input type="text" name="certName" id="certName" class="form-control">
                                </div>
                            </div>
                        <div class="form-group">
                                <div>
                                    <label for="certName">Certificate Awarded:</label>
                                    <input type="text" name="certAward" id="certAward" class="form-control">
                                </div>
                            </div>
                        <div class="form-group">
                                <div>
                                    <label for="classObtained">Class Obtained:</label>
                                    <select class="form-control" name="classObtained" id="classObtained">
                                        <option value="">SELECT CLASS</option>
                                        <option value="FIRST CLASS">FIRST CLASS</option>
                                        <option value="SECOND CLASS LOWER">SECOND CLASS UPPER</option>
                        ...
                        <div style="text-align: center;">
                            <button class="btn btn-sm btn-success" onclick="add_other_veri();">Save</button>
                        </div>
                                ...
                                <form id="exportForm" style="">
                                    ...
                                    <div class="form-group" id="form_grp_1">
                                        <div class="form-label-group">
                                            <select name="category" id="category" class="form-control" required style="text-transform: uppercase;">
                                    ...
                                    <div class="form-group" id="form_grp_3">
                                        <div class="form-label-group">
                                            <select name="programme" id="programme" class="form-control" style="text-transform: uppercase;">
                                    ...
                                    <div class="form-group" id="form_grp_4">
                                        <div class="form-label-group">
                                            <select name="graddate" id="graddate" class="form-control" style="text-transform: uppercase;">
                                    ...
                                    <div class="form-group" id="form_grp_6">
                                        <div class="form-label-group">
                                            <select name="class" id="class" class="form-control" style="text-transform: uppercase;">
                                    ...
                                    <div class="form-group" id="form_grp_7">
                                        <div class="form-label-group">
                                            <select name="status" id="status" class="form-control" style="text-transform: uppercase;">
                 ...
                 <div class="card-body" id="exportTable" style= "display: none;">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id="export_gradTable">
                                ...
                                <tbody id="export_gradBody" style="text-transform: uppercase;">
                    ...
                    <div class="card-body" id="exportTableVerify" style= "display: none;">
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped" id="export_verifyTable">
                                ...
                                <tbody id="export_veriBody" style="text-transform: uppercase;">
        ...
        <div class="modal fade" id="edit" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Search Other Verification</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="editForm">
                            <div class="form-group">
                                <label for="sid" style="font-weight: bold;">Index No / UIN</label>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Other Verification</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="e_otherveriForm">
                            <div class="form-group">
                                <div>
                                    <label for="indexno">Index No:</label>
                                    <input type="text" name="e_indexno" id="e_indexno" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="uin">UIN:</label>
                                    <input type="text" name="e_uin" id="e_uin" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="examDate">Exam Date:</label>
                                    <input type="month" name="e_examDate" id="e_examDate" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="certName">Institution Attended:</label>
                                    <input type="text" name="e_instName" id="e_instName" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="certName">Name on Certificate:</label>
                                    <input type="text" name="e_certName" id="e_certName" class="form-control">
                                </div>
                            </div>
                        <div class="form-group">
                                <div>
                                    <label for="certName">Certificate Awarded:</label>
                                    <input type="text" name="e_certAward" id="e_certAward" class="form-control">
                                </div>
                            </div>
                        <div class="form-group">
                                <div>
                                    <label for="e_classObtained">Class Obtained:</label>
                                    <select class="form-control" name="e_classObtained" id="e_classObtained">
                                        <option value="">SELECT CLASS</option>
                                        <option value="FIRST CLASS">FIRST CLASS</option>
                                        <option value="SECOND CLASS LOWER">SECOND CLASS UPPER</option>
                                        <option value="SECOND CLASS LOWER">SECOND CLASS LOWER</option>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-sm btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        <button onclick="edit_other_veri()" class="btn btn-sm btn-primary">Update</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="veriForm">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    <select name="veri_programme" class="form-control" style="text-transform: uppercase;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="printable" class="table-responsive">
                            <table id="header_tbl" style='border-bottom: 2px solid black;width:100%'>
                            <tr>
                                <td><img src='../images/logo.png' style='width: 150px;'></td>

                                <td style=''>
                                    <div style="text-align: center;color: black;font-weight: bold;font-family: 'new times roman';">
                                        <h2>UNIVERSITY FOR DEVELOPMENT STUDIES</h2>
                                        <p style='font-size: 20px;font-weight: bold;'>ACADEMIC AFFAIRS SECTION</p>
                                        <p style='font-size: 18px;font-weight: normal;'>VERIFICATION DETAILS</p>
                                    </div>
                                </td>
                                <td style="width: 10%">
                        ...
                        <br>
                            <table class="table table-hover table-striped" id="verify_table">
                                ...
                                <tbody id="verify_body" style="text-transform: uppercase;">
            ...
            keep_open("keep-open,index");
                ...
                $("#gradTable").DataTable({
                    ...
                    $("#gradList").click(function() {
                        ...
                        $("#otherveri").removeClass("activeTab");
                        ...
                        document.getElementById("otherveriBody").style.display = 'none';
                    });
                    ...
                    $("#otherveri").click(function() {
                        $("#otherveri").addClass("activeTab");
                        $("#uploadList").removeClass("activeTab");
                        $("#veriList").removeClass("activeTab");
                        $("#gradList").removeClass("activeTab");
                        $("#export").removeClass("activeTab");

                        document.getElementById("otherveriBody").style.display = 'block';
                        document.getElementById("uploadBody").style.display = 'none';
                        document.getElementById("gradBody").style.display = 'none';
                        document.getElementById("veriBody").style.display = 'none';
                        document.getElementById("exportBody").style.display = 'none';
