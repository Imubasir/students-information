...
$sql = "SELECT surname, middlename, firstname, studentbiodata.indexno, gender, dob, sprogid, option_id, pic_id, progname, gradclass, graddate, optionid, option_title FROM arms.studentbiodata LEFT JOIN programme on studentbiodata.sprogid = programme.progid LEFT JOIN tbl_graduate on studentbiodata.indexno = tbl_graduate.indexno LEFT JOIN tbl_option on studentbiodata.option_id = tbl_option.optionid WHERE studentbiodata.indexno = '$id'";
