...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '31' ";
...
<head>
    ...
    <title><?php echo $title."University Halls" ?></title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown active keep-open">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a id="uni_halls" class="dropdown-item active" href="../6540"><i class="fas fa-hotel"></i> University Halls</a>
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">University Halls</li>
                </ol>
                ...
                <div class="card mb-3 animated fadeInRight">
                    ...
                    <div class="card-header">
                        <span id="sub_title">University Halls</span>
                        <span style="float:right;"><button onclick="addHall()" class="btn btn-sm" style="background-color: #31b6418f"><i class="fa fa-plus"></i> Add Hall</button></span>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="hall_tbl">
                                <thead>
                                    <th>#</th>
                                    <th>Name</th>
                                    <th>Capacity</th>
        ...
        <div class="modal fade" id="confirmDel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body" style="text-align: center;color: black;font-size: 15px;"><img src="../images/warning.webp" width="100px" /> <br />Are You Sure Want to Delete this Hall?</div>
                    <div class="modal-footer">
                        <button id="delBtn" class="btn btn-danger btn-sm">Yes, Delete</button>
        ...
        <!-- Delete Modal-->
        <div class="modal fade" id="delHall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Delete Hall</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="addHall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="HallForm">
                            <div class="form-group">
                                ...
                                <input type="text" name="hall_name" class="form-control" placeholder="ENTER NAME OF HALL" />
                            </div>

                            <div class="form-group">
                                <label>Gender Group</label>
                                <select name="hall_gender" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input name="hall_capacity" type="number" class="form-control" />
                            </div>

                            <div class="form-group">
                                <label>Campus</label>
                                <select name="hall_campus" class="form-control">
                                    <option>Select Campus</option>
                                    <?php
                            $rs = mysqli_query($conn, "SELECT * from tbl_campus ORDER BY campus_descr");
                            if($rs) {
                                while($row = mysqli_fetch_assoc($rs)) {
                                    ?>
                                    <option value="<?php echo $row['campus_id'] ?>"><?php echo $row['campus_descr'] ?></option>
                                    <?php
                                    }
                                }
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-danger btn-sm" type="button" data-dismiss="modal">Dismiss</button>
        ...
        <!-- Edit Modal-->
        <div class="modal fade" id="editHall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            <div class="form-group">
                                <label>Hall Name</label>
                                <input type="text" id="Ehall_name" name="Ehall_name" class="form-control" placeholder="ENTER NAME OF HALL" />
                            </div>

                            <div class="form-group">
                                <label>Gender Group</label>
                                <select id="Ehall_gender" name="Ehall_gender" class="form-control">
                                    <option>SELECT GENDER</option>
                                    <option>MALE</option>
                                    <option>FEMALE</option>
                                    <option>MIXED</option>
                            ...
                            <div class="form-group">
                                <label>Capacity</label>
                                <input id="Ehall_capacity" name="Ehall_capacity" type="number" class="form-control" />
                            </div>

                            <div class="form-group">
                                <label>Campus</label>
                                <select id="Ehall_campus" name="Ehall_campus" class="form-control">
                                    <option>Select Campus</option>
                                    <?php
                            $rs = mysqli_query($conn, "SELECT * from tbl_campus ORDER BY campus_descr");
                            if($rs) {
