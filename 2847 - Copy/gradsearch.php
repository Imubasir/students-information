...
if($sid != '' && $name != '' && $prog != '' && $graddate != '') {
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and studentbiodata.sprogid = '$prog' and graddate = '$graddate' ";
} 
else if($name != '' && $prog != '' && $graddate != '') {
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and studentbiodata.sprogid = '$prog' and graddate = '$graddate' ";
} 
    ...
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and graddate = '$graddate' ";
} 
else if ($sid != '' && $name != '' && $prog != '') {
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and studentbiodata.sprogid = '$prog' ";
} 
    ...
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and graddate = '$graddate' ";
} 
else if ($name != '' && $prog != '') {
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' and studentbiodata.sprogid = '$prog' ";
} 
    ...
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where tbl_graduate.indexno = '$sid' and concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' ";
} 
else if ($graddate != '') {
    ...
    $query .= "SELECT * FROM tbl_graduate inner join studentbiodata on tbl_graduate.indexno = studentbiodata.indexno inner join  programme  on studentbiodata.sprogid  = programme.progid where concat_ws(' ', firstname, middlename, surname) LIKE '%{$name}%' ";
}
else if ($sid != '') {
