    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="pg_services_tab" class="dropdown-item" href="../4630">UG Certificates</a>
      ...
      <div id="content-wrapper">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><span><b><span id="mess_count"></span> New Messages!</b></span></div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="../3062">
              ...
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  <div class="card-body-icon">
                    ...
                    <div class="mr-5"><span><b>Requests <br> <span>Transcripts: <span id="tTotal"></span></span> <br> <span>Letters: <span id="lTotal"></span></span></b></span></div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="../6768">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
              ...
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  <div class="card-body-icon">
                    ...
                    <div class="mr-5"><span><b>Enrollments <br> Undergraduate:<span id="uEnrol"></span><br> Postgraduate:<span id="pEnrol"></span> </b></span></div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="../5065">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><span><b>Active Users</b></span></div>
                </div>
        ...
        <div class="card mb-3 animated fadeInRight">
            ...
            <div class="row">
              <div class="col-6">
            		<canvas id="enrollChart" width="250" height="200"></canvas>
              </div>
              <div class="col-6">
                <canvas id="pg_enrollChart" width="250" height="200"></canvas>  
              </div>
            </div>
        	</div>
        </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var x = new Chart(ctx, {
            ...
            options: {
                title: {
                    display: true,
                    text: 'Undergraduate Enrollments',
                    fontStyle: 'bold',
                    position: 'top',
                    fontSize: 23
                },
      ...
      $.ajax({
        ...
        success: function(json) {
          ...
          //console.log(data);
          var ug_value = data['ug'];
          var pg_value = data['pg'];
          var trans = data['trans'];
          var letters = data['letters'];

          $("#uEnrol").html(formatNumber(ug_value));
          $("#pEnrol").html(formatNumber(pg_value));
          $("#tTotal").html(trans);
          $("#lTotal").html(letters);
        }
