...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '21' ";
...
if($result->num_rows>0){
  ...
  <head>
    ...
    <title><?php echo $title."NCTE" ?></title>
...
<div id="wrapper">
  ...
  <ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown active keep-open">
      <a class="nav-link dropdown-toggle index" href="#" id="analytics_tab" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
        ...
        <a id="ncte_tab" class="dropdown-item active" href="../5026">NCTE</a>
      </div>
    </li>
    <!--End of Analytics-->
  ...
  <div id="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">NCTE</li>
      </ol>
      ...
      <div class="card">
          ...
          <div class="default-tab">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Student Data</a>

                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Menu 2</a>
              </div>
            </nav>
            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div style="width: 50%;margin-left: 25%;box-shadow: 9px 4px 2px #c3cac3;padding: 20px">
                  <form id="search_form">
                ...
                <button class="btn btn-flat btn-success" onclick="generate_data();">Generate Data</button>
              </div>
            </div>
        ...
        <div style="display: none;">
          <div class="responsive" style="overflow-x: auto;">
            <table class="table table-hover table-striped" id="report_tbl">
              <thead style="text-transform: capitalize;">
                ...
                <th>disability_descr</th>
                <th>guardian_name</th>
                <th>guardian_address</th>
                <th>relation_guardian</th>
                <th>occupation_guardian</th>
                <th>sponsor</th>
                <th>sprogid</th>
                <th>entryyear</th>
                <th>entrylevel</th>
