...
$user = $_SESSION['uname'];
$sql = "SELECT * FROM tbl_pages where username = '$user' and fpage = '10' ";
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown active keep-open">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a id="certificate_tab" class="dropdown-item active" href="../2847">Certificate</a>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 animated fadeInRight">
                    ...
                    <div class="card-body" id="body1">
                        <div style="width: 60%;margin-left: 15%;box-shadow: 0px 0px 20px 5px #d6d9dc;padding: 20px;">
                            <form id="searchForm">
                                <div class="form-group">
                                    <label>Category</label>
                                    <select class="form-control" name="std_cat" id="std_cat">
                                ...
                                <div class="form-group">
                                    <label>Index No / UIN</label>
                                    <input type="text" name="std_no" class="form-control" />
                                </div>

                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="std_name" class="form-control" placeholder="First name, middle name or last name" />
                                </div>


                                <div class="form-group">
                                    <label>Programme</label>
                                    <select class="form-control" name="std_prog" id="std_prog"></select>
                                </div>

                                <div class="form-group">
                                    <label>Graduation Date</label>
                                    <input type="month" name="std_grad" class="form-control" />
                                </div>

                            </form>
                            <button id="searchBtn" class="btn btn-md btn-success btn-block" onclick="search();"><i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
                        </div>

                    </div>

                    <div class="card-body" style="display: none;" id="body2">
                        <div>
                            <span style="padding: 10px;background-color: #343a40;color: white;" onclick="bckHome();"> Back</span>
                        </div>
                        <br />
                    ...
                    <div class="card-body" style="display: none;" id="body3">
                        <div>
                            <span style="padding: 10px;background-color: #343a40;color: white;" onclick="bckSearch();"> Back</span>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <div style="text-align: center;box-shadow: 4px 4px 10px 5px #49494e;padding: 20px;">
                                    <img id="std_img" src="../images/14020394.jpg" height="100px" width="100px" class="align-self-center rounded-circle mr-3" />

                                    <h4 id="profile_name">Student Name (Index Number)</h4>
                                    <h4 id="profile_prog">Programme</h4>
                                    <h4 id="profile_class">Class</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
          ...
          <div class="modal-body" style="text-transform: uppercase;">
            <table class="table">
              ...
              <tr>
                <td style="font-weight: bold;color: black">Programme</td>
                <td id="prog"></td>
              </tr>

              <tr>
                <td style="font-weight: bold;color: black">Payment Status</td>
                <td id="pay_status"><img src="../images/ajax-loader-small.gif"></td>
              </tr>

              <tr>
                <td style="font-weight: bold;color: black">Gown Status</td>
                <td id="gown_status"></td>
              </tr>

              <tr>
                <td style="font-weight: bold;color: black">Clearence</td>
                <td>
                <select class="form-control" id="clearence_status">
                  <option value="0">Select Clearence Status</option>
          ...
          <div class="modal-footer">
            ...
            <button id="issue_btn" class="btn btn-success btn-sm">Issue</button>
...
-->
    ...
    <div class="modal fade" id="studentSearchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-user-graduate"></i> Student Custom Search</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="enrollForm">
                            ...
                            <div class="form-label-group">
                                <select name="grad_programme" class="form-control" style="text-transform: uppercase;">
                                    ...
                                    <?php
                                                ...
                                                // $sql = "SELECT * FROM arms.programme, arms_pg.programme order by progname";
                                                $sql = "SELECT * FROM arms.`programme` UNION ALL select * FROM arms_pg.programme ORDER BY `progname` ASC";
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <select name="grad_category" class="form-control" style="text-transform: uppercase;">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <button id="studentsearchBtn" class="btn btn-primary">Search</button>
                </div>
            </div>
        </div>
    </div>
