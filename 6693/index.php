...
<head>
    ...
    <title><?php echo $title."Undergraduate Courses" ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
          ...
          <div class = "dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a id="ug_course_tab" class="dropdown-item active" href="../6693"> Courses</a>
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <!-- Breadcrumbs-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Undergraduate</li>
                ...
                <div class="card mb-3 animated fadeInRight">
                    <div class="card-header">
                        <i class=""></i>Undergraduate Courses
                    </div>
